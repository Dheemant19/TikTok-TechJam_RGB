...
from flowstate.knowledge.models import CodeRecord, EvidenceFilters, ProviderResult, ProviderWork
...
class GitHubProvider(KnowledgeProvider):
    ...
    def __init__(self, *, token: str | None, timeout_seconds: float, retry_limit: int, client: httpx.AsyncClient | None = None) -> None:
        headers = {"Accept": "application/vnd.github+json", "X-GitHub-Api-Version": "2022-11-28", "User-Agent": "FlowState/0.1"}
        if token:

...
from flowstate.contract.models import RecoveryReceipt
from flowstate.ledger.workflow import new_id
...
class RecoveryController:
    ...
    def classify(error: str) -> str:
        ...
        if any(term in value for term in ("429", "503", "connection", "rate limit", "throttl", "azure", "openai", "huggingface", "github")):

...
from rigor_rs.knowledge.config import load_knowledge_config
from rigor_rs.knowledge.ingestion import ManifestValidationFailure, validate_manifest
...
def status_command(
    ...
    emit({
        ...
        "counts": runtime.store.counts(), "providers": {
            "openalex": runtime.openalex is not None,
